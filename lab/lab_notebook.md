...
|------|-----------|--------|--------------|
| 2026-06-30 | Installation et configuration initiale d'ARS v3.13.0 | Complété | Système opérationnel |
...
|------|----------|---------------|-----------------------|
| 2026-06-30 | Langue de communication : Français | Préférence utilisateur | English |
| 2026-06-30 | Langue des articles : English | Préférence utilisateur | Français |
| 2026-06-30 | Format de sortie : LaTeX + Word | Flexibilité maximale | LaTeX seul, Word seul |

## Notes libres
*(Observations, intuitions, questions ouvertes)*

## Directions explorées (suite)
| Date | Direction | Statut | Observations |
|------|-----------|--------|--------------|
